  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-3 text-gray-700">
          <p>
            We accept returns of products within {businessInfo.returnDays} days
            of purchase.
          </p>
          ...
          <div className="mt-4">
            ...
            <div className="flex items-start mt-2">
              <span className="mr-2 mt-1">•</span>
              <span>
                [Add non-returnable items here, e.g., perishable goods, custom
        ...
        <div className="space-y-3 text-gray-700">
          ...
          <div className="space-y-2">
            <div className="flex items-start">
              <span className="mr-2 mt-1">•</span>
              <span>
                Approved refunds will be sent to you within{" "}
                {businessInfo.refundProcessingDays} business days.
              </span>
            </div>
            <div className="flex items-start">
              <span className="mr-2 mt-1">•</span>
              <span>
                A partial refund may be issued at our discretion for items that
                are not in their original condition, are damaged, or have
            ...
            <div className="flex items-start">
              <span className="mr-2 mt-1">•</span>
              <span>
                Refunds will be issued through a method communicated to you at
    ...
    },
    {
      ...
      content: (
        <p className="text-gray-700">
          ...
          or <span className="font-semibold">{businessInfo.contactPhone}</span>{" "}
          or submit a return request through {businessInfo.websitePortal}. Our
          team will guide you through the process and provide necessary
          instructions.
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="text-gray-700">
          You are responsible for paying your own shipping costs for returning
    ...
    },
    {
      ...
      content: (
        <p className="text-gray-700">
          We are not liable for any delays in processing returns, exchanges, or
          refunds caused by circumstances beyond our reasonable control,
          including but not limited to natural disasters, strikes, government
          actions, or disruptions in transport or payment systems.
        </p>
      ),
    },
    {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
          ...
          <p className="text-center text-gray-700 text-lg mb-6">
            ...
            <span className="font-semibold">{businessInfo.companyName}</span>.
            We value your satisfaction and strive to provide quality products.
            Please review our refund and return policy below.
          </p>

          {/* Disclaimer */}
          <div
            className="p-5 bg-amber-50 border-l-4 rounded"
            style={{ borderColor: "#770000" }}
          >
            <p className="text-sm text-gray-800 leading-relaxed">
              <span className="font-bold">Disclaimer:</span> Please ensure all
              placeholders (e.g., [Add Your Company Name], [Insert Number]) are
              filled in with your specific business information before
              publishing this policy. This template is a general guide and does
              not constitute legal advice. It is your responsibility to ensure
              this policy complies with all applicable laws and regulations
