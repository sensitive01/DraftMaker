...
import { sendDualNameCorrectionData } from "../../../api/service/axiosService";
...
export default function DualNameChange() {
  ...
  // ✅ Session storage key
  const STORAGE_KEY = "dualNameChange_temp";
  ...
  const handleAdditionalDocumentChange = (index, field, value) => {
    ...
    const updatedData = {
      ...formData,
      additionalDocuments: formData.additionalDocuments.map((doc, i) =>
  ...
  const addDocument = () => {
    ...
    const updatedData = {
      ...
      additionalDocuments: [
        ...
        { id: newId, name: "", document: "", documentNo: "" },
      ],
    };
    setFormData(updatedData);
    saveFormData(updatedData); // ✅ auto-save
