  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200">
      <div className="p-6">
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4 pb-2 border-b-2 border-gray-200 text-gray-800">
        ...
        <div className="mb-8">
          ...
          {/* Table Header */}
          <div className="bg-gray-100 p-3 rounded-t-lg border border-gray-200 font-medium text-gray-700 flex items-center">
          ...
          <div className="border-x border-gray-200">
            {formData.coparceners.length > 0 ? (
              formData.coparceners.map((coparcener, index) => (
                ...
                >
                  <div className="w-12 text-center font-medium text-gray-700 p-3">
                    {index + 1}
                  </div>
              ...
              <div className="flex items-center border-b border-gray-200 bg-white">
                ...
                <div className="w-16 flex justify-center">
                  <button
                    type="button"
                    className="text-red-400 opacity-50 cursor-not-allowed p-1.5"
                    disabled
          ...
          <div className="border border-t-0 border-gray-200 rounded-b-lg py-3 px-4 bg-gray-50 flex justify-end">
            <button
              type="button"
              onClick={addCoparcener}
              className="text-blue-600 hover:text-blue-800 p-1.5 rounded-md hover:bg-blue-50 flex items-center"
