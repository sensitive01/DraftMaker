      ...
      <div className="block sm:hidden">
        {formData.coparceners.length > 0 ? (
          formData.coparceners.map((coparcener, index) => (
            <div key={index} className="bg-white border border-gray-200 rounded-lg p-3 mb-3 shadow-sm">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoparcenerChange(index, "name", e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoparcenerChange(index, "relationship", e.target.value)}
                    className="w-full p-2 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-red-400 focus:border-red-400"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoparcenerChange(index, "address", e.target.value)}
                    className="w-full p-2 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-red-400 focus:border-red-400"
                    placeholder="Address"
                  />
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-3 mb-3 shadow-sm">
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-semibold text-gray-700">Member 1</span>
              <button
                type="button"
            ...
            <div className="space-y-2">
              <div>
                ...
                <input
                  type="text"
                  value=""
                  onChange={(e) => handleCoparcenerChange(0, "name", e.target.value)}
                  className="w-full p-2 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-red-400 focus:border-red-400"
                  placeholder="Full Name"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value=""
                  onChange={(e) => handleCoparcenerChange(0, "relationship", e.target.value)}
                  className="w-full p-2 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-red-400 focus:border-red-400"
                  placeholder="Relationship"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value=""
                  onChange={(e) => handleCoparcenerChange(0, "address", e.target.value)}
                  className="w-full p-2 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-red-400 focus:border-red-400"
                  placeholder="Address"
                />
              </div>
