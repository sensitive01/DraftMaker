            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-5 pl-2 sm:pl-4 md:pl-6 mt-6 sm:mt-8">
              ...
              <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                ...
                <p className="text-justify">
                  ...
                  <strong>{formData.oldName}</strong> (old name) in my official
                  documents.
                </p>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                ...
                <p className="text-justify">
                  ...
                  <strong>{formData.newName}</strong> (new name) in place of my
                  previous name i.e., <strong>{formData.oldName}</strong> (old
                  name).
                </p>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                ...
                <p className="text-justify">
                  ...
                  <strong>{formData.newName}</strong> for all purposes.
                </p>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                ...
                <p className="text-justify">
                  ...
                  hereinabove belong to one and the same person i.e.{" "}
