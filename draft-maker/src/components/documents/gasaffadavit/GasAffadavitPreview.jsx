...
const GasAffadavitPreview = ({ formData }) => {
  return (
    <div className="bg-white p-6 border border-gray-300 rounded shadow">
      ...
      <p className="mb-4">
        I, {formData.fullName} {formData.relation}, {formData.fatherName}, Aged:{" "}
        {formData.age} Years,
      </p>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              {formData.regulatorCount} regulator(s) on loan for my use against
              the refundable deposit of Rs {formData.depositAmount}.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            residing in {formData.previousAddress}. Thereafter, I shifted to my
          ...
          <div>
            {formData.lostItem === "subscription" ? (
              <>
                ...
                with the cylinder and regulator to obtain the refundable deposit
                as it is misplaced / lost.
              </>
            ) : (
              <>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            Voucher / Termination Voucher to M/s. {formData.gasCompanyName} if
            found at any time in the future.
          </div>
        </div>
      ...
      <p className="mt-6">
        Verified at <strong>{formData.place}</strong> on this {getDayWithSuffix(formData.day)} {""} 
