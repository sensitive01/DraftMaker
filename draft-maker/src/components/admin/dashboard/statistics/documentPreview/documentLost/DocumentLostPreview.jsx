    ...
    <div className="border p-6 bg-white shadow-md space-y-6">
      ...
      <ol className="list-decimal pl-6">
        <li className="mb-3">
          ...
          {formData.documentNumber || "..........."}, which I am unable to trace
          even after extensive search.
        </li>

        <li className="mb-3">
          That an FIR has been lodged bearing No {formData.firNumber || "XXXX"}{" "}
          on DATE: {formData.firDay || "XX"}/{formData.firMonth || "XX"}/
          {formData.firYear || "XXXX"} reporting about the loss of{" "}
          {formData.documentType || "DOCUMENT"}, The copy of the same is
          enclosed herewith.
        </li>
