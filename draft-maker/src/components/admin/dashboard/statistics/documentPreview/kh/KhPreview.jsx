  ...
  return (
    <div className="bg-white p-6 rounded-lg border-2 border-gray-300 shadow-lg overflow-auto h-full">
      ...
      <div className="text-sm text-gray-500 mb-8 text-center italic">
        [To be printed on a stamp paper of appropriate value as per State stamp
        duty laws]
      </div>
      ...
      <div className="space-y-4 text-gray-800 leading-relaxed">
        ...
        <p>
          ...
          of <span className="font-medium">{formData.authority || "BBMP"}</span>
          , Khata No is{" "}
          <span className={`font-medium ${highlightIfEmpty(formData.khataNo)}`}>
