...
const BirtCrtificateParentNameCorrection = () => {
  ...
  return (
    <div className="border p-6 bg-white shadow-md space-y-6">
      ...
      <ol className="list-decimal pl-6">
        <li className="mb-3">
          That Birth Certificate SL No: {formData.certificateNumber || "______"}{" "}
          issued for our {formData.childRelation} {formData.childName || "NAME"}{" "}
          from (Chief Register of Births and Deaths, Govt of Karnataka), the
          name of parents issued Father name as{" "}
          {formData.incorrectFatherName || "Incorrect Name"} and Mother name as{" "}
        ...
        <li className="mb-3">
          ...
          {formData.childRelation} Birth Certificate is the name of one and the
          same persons and that is our self's.
        </li>
...
export default BirtCrtificateParentNameCorrection;
