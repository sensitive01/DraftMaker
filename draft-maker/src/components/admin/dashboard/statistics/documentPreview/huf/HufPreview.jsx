      ...
      <div className="p-6 print-container font-serif">
        ...
        <ol className="list-decimal pl-6 mb-6 space-y-3 leading-relaxed">
          <li>
            ...
            <Field value={formData.name} placeholder="[FULL NAME]" inline /> of
            our <strong>HUF</strong> which is known as{" "}
            <strong>
              <Field value={formData.hufName} placeholder="[HUF NAME]" inline />{" "}
              HUF
            </strong>
          </li>
          <li>
        ...
        <p className="mb-10 leading-relaxed">
          Verified at{" "}
          <Field value={formData.place} placeholder="[PLACE]" inline /> on this{" "}
